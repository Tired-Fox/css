...
pub fn build(b: *std.Build) void {
    ...
    const with_static_lib = b.option(bool, "with-static-lib", "Compile as a static library and a zig module") orelse false;
    ...
    const lib = b.addModule(NAME, .{ .root_source_file = LIB_PATH });
